...
int ios_main(IOSNativeApp* pIOSNatvieApp)
{
    ...
    // IMPORTANT: You must set your class name to TestApp (see above) always for iOS
    // Don't worry it will not conflict with any other apps that use the same base class name of TestApp
    // I got your back
